...
Log.addAssert("myJDDData.getCdtsStartsWithStrWithoutDuplicates('AA.BBB' )",listCDTWithoutDuplicates,myJDDData.getCdtsStartsWithStrWithoutDuplicates('AA.BBB' ))
Log.addAssert("myJDDData.getCdtsStartsWithStrWithoutDuplicates('AA.BBB.001.LEC' )",['AA.BBB.001.LEC.01'],myJDDData.getCdtsStartsWithStrWithoutDuplicates('AA.BBB.001.LEC' ))
Log.addAssert("myJDDData.getCdtsStartsWithStrWithoutDuplicates('AA.BBB.001.LEC.01' )",['AA.BBB.001.LEC.01'],myJDDData.getCdtsStartsWithStrWithoutDuplicates('AA.BBB.001.LEC.01' ))
Log.addAssert("myJDDData.getCdtsStartsWithStrWithoutDuplicates('AA.BBB.001.UNK.01' )",[],myJDDData.getCdtsStartsWithStrWithoutDuplicates('AA.BBB.001.UNK.01' ))
Log.addAssert("myJDDData.getCdtsStartsWithStrWithoutDuplicates('BBB.001' )",[],myJDDData.getCdtsStartsWithStrWithoutDuplicates('BBB.001' ))
...
Log.addAssert("concatenateCdtsAndValues(datasListTest, ['ID_JML','ST_INA']",resultList2,myJDDData.concatenateCdtsAndValues(datasListTest, ['ID_JML','ST_INA']))
Log.addAssert("concatenateCdtsAndValues(datasListTest, ['UNK']",[],myJDDData.concatenateCdtsAndValues(datasListTest, ['UNK']))
