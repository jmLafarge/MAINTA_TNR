...
Log.addAssert('IV.getInternalValueOf','$NULL',IV.getInternalValueOf('COM.NU_MET','Non utilisé'))
Log.addAssert('IV.getInternalValueOf','1',IV.getInternalValueOf('MAT.NU_TYP','Suivi en Stock'))

Log.addAssert('IV.getInternalValueOf',null,IV.getInternalValueOf('UNKNOWN','Suivi en Stock'))
Log.addAssert('IV.getInternalValueOf',null,IV.getInternalValueOf('MAT.NU_TYP','UNKNOWN'))
Log.addAssert('IV.getInternalValueOf',null,IV.getInternalValueOf('UNKNOWN','UNKNOWN'))
